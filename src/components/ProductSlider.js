        ...
        <div className='grid grid-cols-2 gap-x-5 md:grid-cols-3 lg:grid-cols-4 lg:gap-[30px]'>
          {page.productList.map((product, index) => {
            ...
            return <div 
              ...
              key={index}>
              <div className='border hover:border-accent rounded-[18px] w-full max-w-[285px] h-full max-h-[292px] flex items-center justify-center mb-[15px] relative transition cursor-pointer'>
                <img src={image.type} alt="" />
                <div className='absolute bottom-4 bg-gray-200 right-[22px] w-8 h-8 rounded-full flex justify-center items-center hover:bg-gray-300 transition'>
